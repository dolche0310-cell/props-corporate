...
(() => {
  ...
  const STROKES = {
    ai: [
      ...
      { d: 'M51.1 3.2 L51.1 47.8',                                  t: 270, u: 230 }  // I 上→下
    ],
    shift: [
      { d: 'M29.5 11.5 C29.5 3.5 6.5 1.5 5.6 13.2 C4.8 23.4 28 21.8 28 33 C28 44.4 5 44.6 4.4 34.2', t: 380, u: 320 }, // S
      { d: 'M47.6 2.2 L47.6 48.2',                                  t: 520, u: 180 }, // h 縦
      { d: 'M47.6 20.5 C52.5 13.2 71.2 12.4 71.2 26.4 L71.2 48.2',  t: 620, u: 200 }, // h アーチ
      { d: 'M87.8 15.2 L87.8 48.2',                                 t: 650, u: 160 }, // i 縦
      { d: 'M87.8 4.8 l0.2 0', dot: true,                           t: 780, u: 100 }, // i ドット
      { d: 'M110.4 48.2 L110.4 12.4 C110.4 5.2 105.2 3.8 101.2 5.4', t: 750, u: 220 }, // f 縦
      { d: 'M99.6 15.4 L117.2 15.4',                                t: 900, u: 150 }, // f 横棒
  ...
  /* 描き始めは FV の立ち上がり(body.fv-in)を待つ。読み込み直後に走らせると
     ...
     オレンジのカプセルが先に出て、そこから 100〜150ms ほど置いて
     描き始める。全体は約1.05秒で描き上がる。 */
  const AFTER_FV = 400;
  const SPEED = 0.9;
