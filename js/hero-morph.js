...
(() => {
  ...
  const STATES = [
    ...
    /* S05。divide: 1点→4点の分裂。時差と弧を掛けると中間形が波打った
       ...
       以前ここに掛けていた輪郭の線描き(dotsFill)は廃止した。丸が
       いったん線になって消え、また現れる見えになっていたため。 */
    { id: 's07', t: 540, e: 'soft', h: 320, divide: true,
      list: [dotG(669.5, 308.5), dotG(768.5, 308.5), dotG(669.5, 393.5), dotG(768.5, 393.5)] },
    /* S06 2本の角丸の棒(Figma 447:32211 / 447:32212)。
       x 644..697 と 743..796、y 246..458、角丸は幅の半分 26.5。
       上下の丸が縦に伸びて寄り添い、1本ずつの棒に融ける。
       丸の半径と棒の角丸が同じ 26.5 なので、端の丸みが変わらず
       「伸びただけ」に見える。 */
    { id: 's07b', t: 540, e: 'soft', h: 420,
      list: [S(capsule(670.5, 272.5, 670.5, 431.5, 26.5)),
             S(capsule(769.5, 272.5, 769.5, 431.5, 26.5))] },
    /* S08 2本が中央で1本の長い棒に融ける */
    { id: 's10', t: 540, divide: true, e: 'soft', h: 360, elastic: true,
